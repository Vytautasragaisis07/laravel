            ...
            <div class="row justify-content-center">
                <div class="col-md-7 mb-5"  data-aos="fade" >
                    ...
                    <form action="#" class="p-5 bg-white">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                <p>Neturite vartotojo? <a href="/registruotis">Registruokis</a></p>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <a href="/prisijungti" class="btn btn-primary py-2 px-4 text-white">Prisijungti</a>
                            </div>
                        </div>
